<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin.future_courses')); ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped mb-none" id="datatable-details">
                    ...
                    <tr>
                        ...
                        <th class="text-center" width="50"><?php echo e(trans('admin.thumbnail')); ?></th>
                        <th class="text-center" width="100"><?php echo e(trans('admin.th_date')); ?></th>
                    ...
                    <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="cu-p" data-toggle="modal" data-target="#description<?php echo e($item->id); ?>"><?php echo e($item->title); ?></td>
                            <td class="text-center"><a href="<?php echo e($item->image); ?>"><?php echo e(trans('admin.view')); ?></a></td>
                            ...
                            <td class="text-center">
                                <?php if($item->mode == 'publish'): ?>
                                    <a href="/admin/request/record/draft/<?php echo e($item->id); ?>" title="Add to waiting list"><i class="fa fa-arrow-down" aria-hidden="true"></i></a>
                                <?php else: ?>
                                    <a href="/admin/request/record/publish/<?php echo e($item->id); ?>" title="Publish item"><i class="fa fa-arrow-up" aria-hidden="true"></i></a>
                                <?php endif; ?>
                                <a href="#" data-href="/admin/request/record/delete/<?php echo e($item->id); ?>" title="Delete" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Requests','Future Courses']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-php-7-3\htdocs\omid-lms\resources\views/admin/request/recordlist.blade.php ENDPATH**/ ?>